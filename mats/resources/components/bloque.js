const bloqueComponent={    
    ...
    computed:{
        ...
        iconoSrc(){
            if(this.ejemplo){
                return "http://192.168.1.105:3000/public/atlasConocimiento/recursos/iconos/iconoEjemplo.svg"
            }
            else if(this.herramientaInteractiva){
                return "http://192.168.1.105:3000/public/atlasConocimiento/recursos/iconos/iconoHerramientaInteractiva.svg"
            }
            else if(this.cuento){
                return "http://192.168.1.105:3000/public/atlasConocimiento/recursos/iconos/iconoCuento.svg"
            }
            else if(this.spoiler){
                return "http://192.168.1.105:3000/public/atlasConocimiento/recursos/iconos/iconoSpoiler.svg"
            }
            else if(this.evaluacion){
                return "http://192.168.1.105:3000/public/atlasConocimiento/recursos/iconos/iconoEvaluacion.svg"
            }
            return "http://192.168.1.105:3000/public/atlasConocimiento/recursos/iconos/puzzlePiece.svg"
        },
        textoCerrarBoton(){
